...
alias imgcat="${HOME}/.iterm2/bin/imgcat"
alias imgls="${HOME}/.iterm2/bin/imgls"
alias it2api="${HOME}/.iterm2/bin/it2api"
alias it2attention="${HOME}/.iterm2/bin/it2attention"
alias it2check="${HOME}/.iterm2/bin/it2check"
alias it2copy="${HOME}/.iterm2/bin/it2copy"
alias it2dl="${HOME}/.iterm2/bin/it2dl"
alias it2getvar="${HOME}/.iterm2/bin/it2getvar"
alias it2git="${HOME}/.iterm2/bin/it2git"
alias it2setcolor="${HOME}/.iterm2/bin/it2setcolor"
alias it2setkeylabel="${HOME}/.iterm2/bin/it2setkeylabel"
alias it2ul="${HOME}/.iterm2/bin/it2ul"
alias it2universion="${HOME}/.iterm2/bin/it2universion"
